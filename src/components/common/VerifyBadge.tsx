...
export const BasicVerifyIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg 
...
export const GoldVerifyIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 24 24" 
    fill="none" 
...
export const PremiumVerifyIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 24 24" 
    fill="none" 
  ...
  return (
    <div
      ...
      className={cn(
        ...
        animate && 'hover:scale-105 hover:shadow-md hover:rotate-1',
        sizes.badge,
        sizes.gap,
        config.colors.bg,
    ...
    >
      ...
      {showLabel && <span className="font-bold tracking-tight">{config.label}</span>}
    </div>
  );
});
...
// Icon-only variant
export const VerifyIcon = React.forwardRef<HTMLDivElement, Omit<VerifyBadgeProps, 'showLabel'>>((props, ref) => (
...
export const FloatingVerifyBadge = React.forwardRef<HTMLDivElement, FloatingVerifyBadgeProps>(({
  position = 'top-right',
  className,
  ...props
}, ref) => {
