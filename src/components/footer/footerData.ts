...
export const FOOTER_NAVIGATION: FooterGroup[] = [
  {
    ...
    links: [
      ...
      { label: "Download App", href: "/download", icon: Smartphone },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "About Developer", href: "/about-developer", icon: User },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Student & Parent Hub", href: "/student/login", icon: BookOpen },
