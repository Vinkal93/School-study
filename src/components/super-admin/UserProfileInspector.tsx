    ...
    <>
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            {activeTab === "details" && (
              <div className="space-y-4">
                ...
                {/* Account Controls Section (Phase 4) */}
                {user.role !== "super_admin" && (
                  <div className="rounded-xl border border-gray-200 bg-gray-50/50 p-4 dark:border-gray-800 dark:bg-gray-900/30 space-y-3">
                    <h4 className="text-xs font-bold uppercase tracking-wider text-gray-800 dark:text-gray-200 flex items-center gap-1.5">
                      ...
                      Privileged Account Status & Restriction Controls
                    </h4>
                    ...
                    <div className="grid grid-cols-2 gap-2 pt-2">
                      {user.status === "restricted" ? (
                        <button
                          ...
                          className="w-full inline-flex items-center justify-center gap-1.5 rounded-lg py-2 text-xs font-bold bg-green-600 text-white hover:bg-green-700 transition-colors"
                        >
                        ...
                        <button
                          ...
                          className="w-full inline-flex items-center justify-center gap-1.5 rounded-lg py-2 text-xs font-semibold border border-amber-300 bg-amber-50 text-amber-800 hover:bg-amber-100 dark:border-amber-900/40 dark:bg-amber-950/30 dark:text-amber-300 transition-colors"
                        >
                          <ShieldAlert className="h-3.5 w-3.5" />
                          Restrict Account
                        </button>
                      ...
                      {user.status === "active" ? (
                        <button
                          ...
                          className="w-full inline-flex items-center justify-center gap-1.5 rounded-lg py-2 text-xs font-bold bg-red-600 text-white hover:bg-red-700 transition-colors"
                        >
      ...
      {currentUser && (
        <AccountRestrictionModal
          ...
          onRestricted={(updated) => onUserUpdated?.(updated)}
      ...
      {currentUser && (
        <StatusChangeConfirmModal
          ...
          onSuccess={(updated) => onUserUpdated?.(updated)}
          performerUid={currentUser.uid}
        />
      )}
    </>
