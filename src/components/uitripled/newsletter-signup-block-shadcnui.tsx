          ...
          <div className="grid gap-8 p-8 md:grid-cols-2 md:p-12">
            ...
            >
              ...
              <h2 className="mb-4 text-3xl font-bold tracking-tight md:text-4xl text-foreground">
                Join 500+ School Leaders
              </h2>
              <p className="mb-6 text-muted-foreground text-sm leading-relaxed">
                Get weekly actionable insights on school administration efficiency, fee recovery strategies, NEP guidelines, and smart campus innovation delivered directly to your inbox.
              </p>

              <div className="flex flex-wrap gap-2">
                {["Weekly Strategies", "Fee & Attendance Guides", "Zero Spam"].map(
                  (feature, index) => (
                    <motion.div
                      key={feature}
