...
export const GRANULAR_PERMISSIONS: GranularPermissionDefinition[] = [
  ...
  {
    id: "fee_structures",
    name: "Fee Structures Management",
    category: "page",
    featureKey: "fee_structures",
    parentKey: "fee_management",
    description: "Create and manage fee heads, class fee structures, and frequencies (/admin/fees/structures).",
    defaultPlans: ["professional", "enterprise"],
    aliases: ["fee_structure", "fees.structure", "fees.structures"],
  },
  {
    id: "fee_student_fees",
    name: "Student Fees Directory",
    category: "page",
    featureKey: "fee_student_fees",
    parentKey: "fee_management",
    description: "View and manage individual student fee allocations and dues (/admin/fees/student-fees).",
    defaultPlans: ["professional", "enterprise"],
    aliases: ["fees.student_fees", "student_fee_assignments"],
  },
  {
    id: "fee_collect",
    name: "Collect Fee Desk",
    category: "page",
    featureKey: "fee_collect",
    parentKey: "fee_management",
    description: "Record student fee payments, partial/full settlements, and print slips (/admin/fees/collect).",
    defaultPlans: ["professional", "enterprise"],
    aliases: ["fee_collection", "fees.collect", "fees.payment"],
  },
  {
    id: "fee_transactions",
    name: "Fee Transactions Log",
    category: "page",
    featureKey: "fee_transactions",
    parentKey: "fee_management",
    description: "Chronological financial payment transaction history and audits (/admin/fees/transactions).",
    defaultPlans: ["professional", "enterprise"],
    aliases: ["fees.transactions", "fees.payments_log"],
  },
  {
    id: "fee_ledger",
    name: "Student Fee Ledger",
    category: "page",
    featureKey: "fee_ledger",
    parentKey: "fee_management",
    description: "Professional student financial statement of account and balance reconciliation (/admin/fees/ledger).",
    defaultPlans: ["professional", "enterprise"],
    aliases: ["fees.ledger", "student_ledger", "fees.student_ledger"],
  },
  {
    id: "fee_cash_bank",
    name: "Cash & Bank Ledger Hub",
    category: "page",
    featureKey: "fee_cash_bank",
    parentKey: "fee_management",
    description: "Real-time Cash Drawer, UPI, and Bank Account inflow/outflow ledgers (/admin/fees/cash-bank).",
    defaultPlans: ["professional", "enterprise"],
    aliases: ["fees.cash_bank", "cash_bank_ledger", "fees.accounts"],
  },
  {
    id: "fee_defaulters",
    name: "Dues & Defaulters Tracking",
    category: "page",
    featureKey: "fee_defaulters",
    parentKey: "fee_management",
    description: "Aging defaulters list, overdue penalties, and automated parent fee reminders (/admin/fees/defaulters).",
    defaultPlans: ["professional", "enterprise"],
    aliases: ["fees.defaulters", "fee_dues", "fees.dues"],
  },
  {
    id: "fee_discounts",
    name: "Discounts & Concessions",
    category: "page",
    featureKey: "fee_discounts",
    parentKey: "fee_management",
    description: "Apply scholarships, sibling concessions, and discretionary waivers (/admin/fees/discounts).",
    defaultPlans: ["professional", "enterprise"],
    aliases: ["fees.discounts", "fees.scholarships", "fees.concessions"],
  },
  {
    id: "fee_receipts",
    name: "Official Receipts Console",
    category: "page",
    featureKey: "fee_receipts",
    parentKey: "fee_management",
    description: "Reprint, verify, and download official stamped payment receipts (/admin/fees/receipts).",
    defaultPlans: ["professional", "enterprise"],
  ...
  },
  {
    ...
    category: "page",
    featureKey: "fee_reports",
    parentKey: "fee_management",
    description: "Comprehensive class-wise, head-wise, and periodic financial analytics (/admin/fees/reports).",
    defaultPlans: ["professional", "enterprise"],
    aliases: ["fees.reports", "fees.analytics"],
  },
  {
    id: "fee_settings",
    name: "Fee Rules & Settings",
    category: "page",
    featureKey: "fee_settings",
    parentKey: "fee_management",
    description: "Configure late fee rules, grace periods, offline receipt prefixes, and payment accounts (/admin/fees/settings).",
    defaultPlans: ["professional", "enterprise"],
    aliases: ["fees.settings", "fee_rules"],
  },
  {
    id: "fee_accounting",
    name: "Accounting & Trial Balance",
    category: "page",
    featureKey: "fee_accounting",
    parentKey: "fee_management",
    description: "Double-entry journal vouchers, general ledger, and institutional Trial Balance statement (/admin/fees/accounting).",
    defaultPlans: ["enterprise"],
    aliases: ["fees.accounting", "trial_balance", "general_ledger"],
  },
  {
