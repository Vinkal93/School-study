...
/**
 * Browser-side export executed directly using the authenticated client SDK.
 * Bypasses serverless permission boundaries and runs with full user session authorization.
 */
